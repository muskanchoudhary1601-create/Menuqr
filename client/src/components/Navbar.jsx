        ...
        <div className="flex items-center justify-between h-16">
          ...
          {user ? (
            ...
            <div className="hidden sm:flex items-center gap-3">
              <Link
                to="/login"
                className="text-sm font-semibold text-slate-700 hover:text-orange-600 px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors"
              >
                Log In
              </Link>
              <Link
                to="/register"
                className="btn-glow flex items-center gap-1.5 text-sm font-semibold bg-gradient-to-r from-orange-500 to-amber-600 text-white px-4 py-2 rounded-xl shadow-sm shadow-orange-500/20"
              >
