      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col items-center">
            <div className="w-full max-w-sm bg-white rounded-3xl border border-slate-200 shadow-card p-6 text-center transition-all duration-300 hover:shadow-card-hover">
              ...
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <div className="text-left">
                  ...
                  <span className="text-[10px] text-slate-400 font-medium">Digital Table Menu</span>
                </div>
              </div>
              ...
              {/* Instruction Badge */}
              <div className="mt-5 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-semibold">
              ...
              <div className="mt-4 pt-4 border-t border-slate-100">
                <button
                  onClick={copyLink}
                  className="w-full flex items-center justify-between px-3 py-2 rounded-xl bg-slate-50 hover:bg-orange-50/70 border border-slate-200/70 text-left transition-all duration-200 group"
                >
